<template>
    <section id="profile" class="w-full">
        ...
        <BodyPage v-if="user.node_id">
            <header class="profile.header w-full relative">
                ...
                >
                    ...
                    <section class="profile.username">
                        <div
                            class="md:pl-8 md:pb-4 inline-block md:w-auto w-full"
                        >
                            <h2
                                v-if="user.name"
                            ...
                            <h4
                                v-if="user.login"
                                class="lg:text-md text-sm md:text-right text-center text-gray-900 font-light"
                            >
                    ...
                    >
                        <div class="lg:px-4 md:px-2 md:w-auto w-4/12">
                            <p
                                class="text-center lg:text-xl text-sm text-blue-900 m-0"
                            >
                                <i class="fa fa-male"></i>
                                <small class="px-1">{{ user.following }}</small>
                            </p>
                            <p
                                class="text-center lg:text-xl text-sm text-blue-900 m-0"
                            >
                        ...
                        <div class="lg:px-4 md:px-2 md:w-auto w-4/12">
                            ...
                            >
                                ...
                                <small class="px-1">{{ user.followers }}</small>
                            </p>
                            <p
                                class="text-center lg:text-xl md:text-sm text-sm text-blue-900 m-0"
                            >
                                Seguidores
                            </p>
                        </div>
            ...
            >
                <aside
                    class="profile.aside lg:w-3/12 md:w-4/12 w-full md:shadow"
                >
                    <section class="w-full md:pt-16">
                        <nav class="w-full">
                            <ul class="bg-blueg-100 w-full flex flex-wrap">
                                ...
                                <li
                                    id="course_button"
                                    class="profile.navigation w-full relative"
                                >
