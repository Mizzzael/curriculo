<template>
    <section id="repos" class="w-full pt-6 pb-4">
        ...
        <section
            ...
            class="md:w-8/12 w-11/12 mx-auto"
        >
            <Empty />
        </section>
        ...
        <section
            class="md:w-4/12 w-8/12 mx-auto"
            v-if="endPage && repos.length"
        >
            <End />
        </section>
    </section>
...
import Repos from "../assets/js/repos-data.json";
export default {
    name: "Repos",
    data() {
        return {
            ...
            setTimeout(() => {
                if (
                    ...
                    window.document
                        ...
                        .scrollTo(
                            0,
                            window.document.querySelector("#profileviews")
                                .scrollHeight
                        );
                } else {
                    window.scrollTo(
        ...
        if (
            ...
            profileviews.addEventListener(
                ...
                () => {
                    ...
                    const windowHeight = profileviews.getBoundingClientRect()
                        .height;
                    if (
